...
<body>
    ...
    <div class="auth-card">
        ...
        <h3 class="text-center fw-bold mb-1">SCR Intelligence</h3>
        <p class="text-center text-muted mb-4">Enterprise Supply Chain Risk Monitoring</p>

        @if(session('toast_info'))
            <div class="alert alert-info bg-opacity-10 text-info border-info border-opacity-25 rounded-3 text-center mb-3">
                {{ session('toast_info') }}
            </div>
        @endif
        ...
        <form action="{{ route('login') }}" method="POST">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4 small">
                <div class="form-check">
                    ...
                    <label class="form-check-label text-secondary" for="remember">Keep me logged in</label>
                </div>
            </div>
